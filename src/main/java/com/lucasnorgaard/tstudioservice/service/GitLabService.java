...
public class GitLabService {
    ...
    public Repository getRepoWithId(String id) {
        ...
        String lang;
        try {
            repo = Application.getGitLabApi().getProjectApi().getProject(id);
            lang = Utils.maxUsingStreamAndLambda(Application.getGitLabApi().getProjectApi().getProjectLanguages(id));
            if (repo.getName() == null) {
                ownerName = repo.getNamespace().getName();
            } else {
                ownerName = repo.getName();
            }
        ...
        return new Repository(repo.getName(), ownerName, lang, c);
    }
